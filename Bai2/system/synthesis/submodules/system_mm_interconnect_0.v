...
module system_mm_interconnect_0 (
	...
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> switch_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // switch_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> switch_s1_agent:cp_channel
	...
	wire  [94:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [94:0] cmd_demux_001_src3_data;                                                            // cmd_demux_001:src3_data -> cmd_mux_005:sink1_data
	wire         cmd_demux_001_src3_ready;                                                           // cmd_mux_005:sink1_ready -> cmd_demux_001:src3_ready
	wire   [5:0] cmd_demux_001_src3_channel;                                                         // cmd_demux_001:src3_channel -> cmd_mux_005:sink1_channel
	...
	wire  [94:0] rsp_demux_005_src1_data;                                                            // rsp_demux_005:src1_data -> rsp_mux_001:sink3_data
	wire         rsp_demux_005_src1_ready;                                                           // rsp_mux_001:sink3_ready -> rsp_demux_005:src1_ready
	wire   [5:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> rsp_mux_001:sink3_channel
